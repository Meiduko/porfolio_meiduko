...
export const ui = {
  es: {
    ...
    "Title.span": "+2 años",
    "Title.p": "de aprendizaje y desarrollo frontend. Foco en escribir código mantenible y eficiente, equilibrando esfuerzos de optimización con el valor real. Preocupación profunda por la accesibilidad y la experiencia de usuario, adaptando las interfaces a diversos públicos. Sólida capacidad de comunicación y mentalidad analítica. Ambición de crecimiento profesional y liderazgo de proyectos en el futuro.",
  ...
  gl: {
    ...
    "Title.span": "+2 anos",
    "Title.p": "de pretendizaxe e desenvolvemento frontend. Foco en escribir código mantible e eficiente, equilibrando esforzos de optimización co valor real. Preocupación profunda pola accesibilidade e a experiencia de usuario, adaptando as interfaces ós diversos públicos. Sólida capacidade de comunicación e mentalidade analítica. Ambición de crecemento profesional e liderazgo de proxectos no futuro.",
  ...
  en: {
    ...
    "Title.span": "+2 years",
    "Title.p": "learning and hands-on experience in frontend development. Focus on writing maintainable, and efficient code while balancing optimization efforts with real-world value. Deep care about accessibility and user experience, tailoring interfaces to diverse audiences. Strong communication and analytical mindset. Ambition to grow professionally and lead projects in the future.",
